...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/jYZsEpv.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐂𝚫𝚻 𝐒𝚸𝐘;𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷;https://i.imgur.com/jYZsEpv.jpeg;https://chat.whatsapp.com/Gz866L8ZATyJvDx6YZHctQ',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝐂𝚫𝚻 𝐒𝚸𝐘",
    ...
    LANGUAGE: process.env.LANGUAGE || 'english','malayalam',
    DEBUG: DEBUG,
